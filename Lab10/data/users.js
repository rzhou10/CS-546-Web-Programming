...
const findById = function findById(usr_id) {
    return users.find(o => {return o._id === usr_id});
}

const findByUsername = function findByUsername(usr) {
    return users.find(o => {return o.username === usr});
}
